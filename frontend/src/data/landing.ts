import { BookOpen, Brain, Flame, Headphones, Sparkles, Star, TrendingUp } from "lucide-react";
...
export const FEATURES = [
  {
    ...
    desc: "Spaced repetition algorithm adapts to your learning pace, ensuring efficient memorization and long-term retention.",
  ...
  },
  {
    ...
    desc: "Engaging content with furigana support, example sentences, and immediate feedback on every exercise.",
  ...
  },
  {
    ...
    desc: "Native audio recordings and pronunciation practice to develop natural speaking and listening skills.",
  ...
  },
  {
    ...
    desc: "Detailed statistics, streak tracking, and achievement system to keep you motivated on your journey.",
