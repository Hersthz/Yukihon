          ...
          {isQuizLoading ? (
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                <Button className="rounded-2xl bg-amber-500 text-white hover:bg-amber-400" disabled={gradingQuiz} onClick={onSubmitCheckpoint}>
                  Cham checkpoint
                </Button>
                {quizPassed === false ? (
                  <Button className="rounded-2xl" disabled={gradingQuiz} onClick={onResetQuiz} variant="outline">
                    Lam lai
                  </Button>
                ) : null}
              </div>
