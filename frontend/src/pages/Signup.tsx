...
import patternImage from "@/assets/pattern-zen.jpg";
...
const Signup = () => {
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      {/* Left side - Branding */}
      <div 
        className="hidden lg:flex flex-col justify-center items-center p-12 bg-cover bg-center relative"
      ...
      >
        ...
        <div className="relative z-10 text-white text-center space-y-6 max-w-md">
          <div className="flex items-center justify-center space-x-2 mb-8">
            <div className="flex h-16 w-16 items-center justify-center rounded-lg bg-white text-primary font-bold text-2xl">
              日
            </div>
          </div>
          <h1 className="text-4xl font-bold">Start your journey today</h1>
          <p className="text-lg text-white/90">
            Join thousands of learners mastering Japanese through focused, daily practice.
          </p>
          <div className="flex flex-col gap-3 text-left pt-4">
            <div className="flex items-center gap-3">
              <div className="h-8 w-8 rounded-full bg-white/20 flex items-center justify-center">✓</div>
              <span>15-minute daily lessons</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="h-8 w-8 rounded-full bg-white/20 flex items-center justify-center">✓</div>
              <span>Complete JLPT preparation</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="h-8 w-8 rounded-full bg-white/20 flex items-center justify-center">✓</div>
