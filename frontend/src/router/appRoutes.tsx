...
const DeckExplorePage = lazy(() => import("@/pages/decks/DeckExplorePage"));
const DeckPreviewPage = lazy(() => import("@/pages/decks/DeckPreviewPage"));
...
const KanaShark = lazy(() => import("@/pages/KanaShark"));
const CardTemplatesPage = lazy(() => import("@/pages/CardTemplatesPage"));
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route path="/decks/explore" element={withProtectedRoute(<DeckExplorePage />)} />
        <Route path="/decks/:deckId/preview" element={withProtectedRoute(<DeckPreviewPage />)} />
        ...
        <Route path="/kana-shark" element={withProtectedRoute(<KanaShark />)} />
        <Route path="/card-templates" element={withProtectedRoute(<CardTemplatesPage />)} />
