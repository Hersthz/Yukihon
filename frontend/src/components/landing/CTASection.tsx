    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <svg
            className="absolute top-10 right-10 w-64 h-64 text-white/[0.03] rotate-12"
            viewBox="0 0 200 200"
            fill="currentColor"
          >
          ...
          <svg
            className="absolute -bottom-10 -left-20 w-96 h-96 text-white/[0.02]"
            viewBox="0 0 200 200"
            fill="currentColor"
          >
            <path d="M160,100c0-22.1-17.9-40-40-40c-5.7,0-11,1.2-15.8,3.3C96.2,51.1,84.1,44,70,44c-24.3,0-44,19.7-44,44c0,2.1,0.2,4.2,0.5,6.2C11.5,99.4,0,113.3,0,130c0,22.1,17.9,40,40,40h120c22.1,0,40-17.9,40-40C200,107.9,182.1,90,160,100z" />
        ...
        <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
          ...
          <p className="text-lg md:text-2xl text-white/70 mb-12 font-medium max-w-2xl leading-relaxed">
            Experience a peaceful, effective journey to fluency with Kaoruko. No stress, just
            magical progress.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center w-full sm:w-auto">
            ...
            <Link to="/courses">
              <Button
                size="lg"
                variant="outline"
                className="h-16 px-10 text-xl rounded-full border-white/20 bg-white/5 backdrop-blur-md text-white hover:bg-white/10 transition-colors"
              >
                Explore courses
              </Button>
            </Link>
