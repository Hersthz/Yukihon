...
public class UserProgressController {
    ...
    @GetMapping
    public ResponseEntity<List<UserProgressDto>> getUserProgress(@AuthenticationPrincipal UserDetails userDetails) {
    ...
    public ResponseEntity<List<UserProgressDto>> getUserProgressByStatus(
            @PathVariable Long userId, @PathVariable String status, @AuthenticationPrincipal UserDetails userDetails) {
        assertCanAccessUser(userDetails, userId);
