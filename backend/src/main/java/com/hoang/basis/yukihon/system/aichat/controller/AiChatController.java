...
public class AiChatController {
    ...
    public ResponseEntity<AiChatResponse> respond(
            @AuthenticationPrincipal UserDetails userDetails, @Valid @RequestBody AiChatRequest request) {
    ...
    public ResponseEntity<AiChatConversationDto> createConversation(@AuthenticationPrincipal UserDetails userDetails) {
        Long userId = getUserId(userDetails);
    ...
    @GetMapping("/history")
    public ResponseEntity<List<AiChatHistoryItemDto>> getHistory(@AuthenticationPrincipal UserDetails userDetails) {
        Long userId = getUserId(userDetails);
