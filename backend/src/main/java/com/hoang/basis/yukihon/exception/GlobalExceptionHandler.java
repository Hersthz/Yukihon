...
public class GlobalExceptionHandler {
    ...
    private ResponseEntity<ApiError> buildErrorResponse(
        ...
        ApiError body = new ApiError(status.value(), code.name(), message, request.getRequestURI());
    ...
    public ResponseEntity<ApiError> handleServiceUnavailable(
        ...
        return buildErrorResponse(
                HttpStatus.SERVICE_UNAVAILABLE, ErrorCode.SERVICE_UNAVAILABLE, ex.getMessage(), request);
    }
    ...
    public ResponseEntity<ApiError> handleOther(Exception ex, HttpServletRequest request) {
        return buildErrorResponse(
                HttpStatus.INTERNAL_SERVER_ERROR, ErrorCode.INTERNAL_ERROR, "Unexpected internal error", request);
    }
}
