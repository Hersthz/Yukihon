...
public class UserSettingsService {
    ...
    public UserSettingsDto getSettings(Long userId) {
        UserSettings settings = settingsRepository.findByUserId(userId).orElseGet(() -> initializeSettings(userId));
    ...
    public UserSettingsDto updateSettings(Long userId, UpdateSettingsRequest request) {
        ...
        if (request.getJlptDeadlineDate() != null)
            settings.setJlptDeadlineDate(parseDeadlineDate(request.getJlptDeadlineDate()));
